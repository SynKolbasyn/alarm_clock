...
etalon_edges_with_names = get_named_edges(get_keypoints(template), frame_width, frame_height)
...
while True:
    ...
    locs, edges, colors, edges_with_names = keypoints_and_edges_for_display(get_keypoints(frame, from_nparray=True), frame_width, frame_height)
    #i know, where locs
