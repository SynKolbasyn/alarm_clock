...
frame_width = 1280
frame_height = 720
etalon_keypoints, etalon_edges, colors, etalon_edges_with_names = keypoints_and_edges_for_display(get_keypoints(template), frame_width, frame_height)
...
async def root(request: Request):
    ...
    keypoints, edges, edge_colors, edges_with_names = keypoints_and_edges_for_display(get_keypoints(image))
